...
exports.VercelAIBackendBase = void 0;
const ai_1 = require("ai");
class VercelAIBackendBase {
    name;
    description;
    config = {};
    freeCADBridge = null;
    ...
    async initialize(config) {
        ...
        this.config = {
            baseUrl: config.baseUrl || process.env[`${prefix}BASE_URL`] || this.getDefaultBaseUrl(),
            apiKey: config.apiKey || process.env[`${prefix}API_KEY`],
            model: config.model || process.env[`${prefix}MODEL`] || this.getDefaultModel(),
...
Objects: ${context.documentInfo.objectCount}`;
    ...
    async initializeMCPTools(tools) {
        const mcpTools = {};
    ...
    async executeViaBridge(toolName, args) {
...
exports.VercelAIBackendBase = VercelAIBackendBase;
//# sourceMappingURL=vercel-ai-backend-base.js.map